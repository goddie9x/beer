...
class TimeAnalog extends Model
{
    ...
    public function getAnalog($timeStart,$timeEnd='',$device='',$unit='', $locationID='',$objectID=''){
        ...
        ->select('Device.DeviceID','Device.Dev_Name','Device.Dev_Des','Object.Obj_Name','Time_Analog.Value', 'Time_Analog.Recordtime','Device.Dev_Unit','Threshold.t_ceil','Threshold.t_floor')
        ->where($where)
